...
package com.example.compose.dothack.ui.theme
...
/**
 * A [MaterialTheme] for PackView.
 */
@Composable
fun PackViewTheme(content: @Composable () -> Unit) {
 ...
 */
@Composable
fun PackViewDialogThemeOverlay(content: @Composable () -> Unit) {
    // PackView is always dark themed.
